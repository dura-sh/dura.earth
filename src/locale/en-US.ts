...
export default {
  ...
  messages: {
    ...
    'app.header.menu.home': 'homepage',
    'app.header.menu.docs': 'documentation',
    ...
    'app.home.slogan': 'Indiviual reality. There is only one you in this world.',
    'app.home.claim': 'claim your durable identity',
    'app.home.understand': 'understand the * above',
    'app.home.joinus': 'add a * to dura',
    'app.home.download': 'Download',
    'app.home.letspro': 'Run commands below, explore it!',
    'app.home.selectpro': 'Select Dura.*',
